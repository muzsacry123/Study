...
\begin{parts}
    ...
    % \part Consider the following data which shows the score of 5 students out of 100 in an ML exam: $S =[70,60,20,80,90]$.
    % \begin{subparts}
    % \subpart[1] \sone The instructor of the course feels that the distribution of scores obtained by students is generated by the following random variable: $P(X \ge 50) = 0.75$, $P(X < 50) = 0.25$. Where $X$ is the score obtained by the students out of 100. What is the probability of observing the data mentioned above assuming it was generated by this random variable? You can assume that the score of all students are independent of one another. 
    ...
    % \subpart[1] Note that the probability of this data sample would be greater if the value of $P(X \ge 50)$ was not 0.75, but instead some other value. What is the value of $P(X \ge 50)$ that maximizes the probability of the sample $S$? Provide your answer as a fraction.
